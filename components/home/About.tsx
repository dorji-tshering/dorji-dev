...
const About = () => {
    ...
    return (
        <div className="homeSectionContainer">
            <h1 className="text-[#222] dark:text-myCyan/90 ubuntu text-xl text-center font-bold mb-10">Few words about me.</h1>
            <div className="flex flex-col items-center relative -bottom-2 -mb-12">
                ...
                <div className="relative">
                    <p className="pt-[110px] bg-theme/10 rounded-md px-6 pb-7 sm:px-10 sm:pb-9
                        relative -top-20 max-w-2xl text-center z-10 shadow-mainShadow">
